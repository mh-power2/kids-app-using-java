 ...
 * @author hp
 */
public class color_exam2 extends javax.swing.JFrame {

    /**
     * Creates new form color_exam2
     */
    public color_exam2() {
        initComponents();
        scaleImage();
...
public void scaleImage8()
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        color_exam3 ce3 = new color_exam3();
        ce3.show();
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(color_exam2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new color_exam2().setVisible(true);
            }
        });
    }
