 ...
 * @author hp
 */
public class color_exam extends javax.swing.JFrame {

    /**
     * Creates new form color_exam
     */
    public color_exam() {
        initComponents();
        scaleImage();
...
public void scaleImage8()
    ...
    private void initComponents() {
        ...
        jLabel3.getAccessibleContext().setAccessibleName("Where is the ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(color_exam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new color_exam().setVisible(true);
            }
        });
    }
